...
// Database settings
define("C_DB_NAME", 'u817352479_yvyba');						// Logical database name on that server (most common like: cpanelusername_databasename)
define("C_DB_USER", 'u817352479_yhasu');				// Database username (most common like: cpanelusername_username)
define("C_DB_PASS", 'yzeSyQuqet');				// Database user's password
// We recommend you keep the names below
define("C_DB_HOST", 'mysql');				// Hostname of your MySQL server (most common "localhost", but sometimes "mysql.domain.com")
define("C_DB_TYPE", 'mysql');						// SQL server type ("mysql", "pgsql" or "odbc") define('C_DB_PREFIX', 'czzk_');
